...
{    
    ...
    public Entity1()
    {
        ...
        for(int i = 0; i < neighbors.length; i++) {
            Packet packet = new Packet(1, neighbors[i], minDistances);
            NetworkSimulator.toLayer2(packet);
        }

        // debug/info logging
        System.out.println("Entity1 Initialized at." + ". Distance Table is:\n");
        printDT();
    }
    ...
    public void update(Packet p)
    {
        ...
        // debug/info logging
        System.out.println("Entity1 Updated." + ". Distance Table is:\n");
        printDT();
    }
    ...
    public void linkCostChangeHandler(int whichLink, int newCost)
    {
        ...
        // debug/info logging
        System.out.println("Entity1 Link Change Cost Completed." + ". Distance Table is:\n");
        printDT();
    }
