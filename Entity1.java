...
{    
    ...
    public Entity1()
    {
        ...
        // 1 is not connected to three so we initialize it to inf
        ...
        for(int i = 1; i < numEntities; i++) {
            Packet packet = new Packet(1, i, minDistances);
            NetworkSimulator.toLayer2(packet);
        }

        // debug/info logging
        System.out.println("Entity1 Initialized at:" + NetworkSimulator.time + ". Distance Table is:\n");
        printDT();
    }
    ...
    public void update(Packet p)
    {
        ...
        if( changed ){
            System.out.println("Detected a min distance change at Entity1... broadcasting to other nodes.\n");
            for (int i = 1; i < numEntities; i++) {
                Packet packet = new Packet(1, i, minDistances);
                NetworkSimulator.toLayer2(packet);
            }
        ...
        // debug/info logging
        System.out.println("Entity1 Updated at:" + NetworkSimulator.time + ". Distance Table is:\n");
        printDT();
    }
    ...
    public void linkCostChangeHandler(int whichLink, int newCost)
    {
        ...
        // debug/info logging
        System.out.println("Entity1 Link Change Cost Completed at:" + NetworkSimulator.time + ". Distance Table is:\n");
        printDT();
    }
